...
export const QUERY = {
    ...
    CREATE_PATIENT: 'INSERT INTO patients(first_name, last_name, email, addrss, dignosis, phone, image_url) VALUES(?, ?, ?, ?, ?, ?, ?)',
    UPDATE_PATIENT: 'UPDATE patients SET first_name = ?, last_name = ?, email = ?, addrss = ?, dignosis = ?, phone = ?, image_url = ? WHERE id = ?',
